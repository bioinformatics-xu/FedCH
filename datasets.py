...
class kaggle(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/kaggle/X_train.npy")
            self.targets = np.load("data/kaggle/y_train.npy")
        else:
            self.data = np.load("data/kaggle/X_test.npy")
            self.targets = np.load("data/kaggle/y_test.npy")
...
class heart(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/heart/X_train.npy")
            self.targets = np.load("data/heart/y_train.npy")
        else:
            self.data = np.load("data/heart/X_test.npy")
            self.targets = np.load("data/heart/y_test.npy")
...
class coronary123(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/coronary123/X_train.npy")
            self.targets = np.load("data/coronary123/y_train.npy")
        else:
            self.data = np.load("data/coronary123/X_test.npy")
            self.targets = np.load("data/coronary123/y_test.npy")
...
class coronary1(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/coronary1/X_train.npy")
            self.targets = np.load("data/coronary1/y_train.npy")
        else:
            self.data = np.load("data/coronary1/X_test.npy")
            self.targets = np.load("data/coronary1/y_test.npy")
...
class coronary2(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/coronary2/X_train.npy")
            self.targets = np.load("data/coronary2/y_train.npy")
        else:
            self.data = np.load("data/coronary2/X_test.npy")
            self.targets = np.load("data/coronary2/y_test.npy")
...
class CoronaryHeartDisease(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/CoronaryHeartDisease/X_train.npy")
            self.targets = np.load("data/CoronaryHeartDisease/y_train.npy")
        else:
            self.data = np.load("data/CoronaryHeartDisease/X_test.npy")
            self.targets = np.load("data/CoronaryHeartDisease/y_test.npy")
...
class  HeartAttackDataset (MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/HeartAttackDataset/X_train.npy")
            self.targets = np.load("data/HeartAttackDataset/y_train.npy")
        else:
            self.data = np.load("data/HeartAttackDataset/X_test.npy")
            self.targets = np.load("data/HeartAttackDataset/y_test.npy")
...
class HeartDiseaseDataset(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/HeartDiseaseDataset/X_train.npy")
            self.targets = np.load("data/HeartDiseaseDataset/y_train.npy")
        else:
            self.data = np.load("data/HeartDiseaseDataset/X_test.npy")
            self.targets = np.load("data/HeartDiseaseDataset/y_test.npy")
